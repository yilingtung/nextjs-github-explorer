...
import { GITHUB_API_ENDPOINT } from '@src/utils/constants';

type Params = {
  nameList: string[];
};

const getRecommendSimpleOrganizations = async ({ nameList }: Params) => {
...
export default getRecommendSimpleOrganizations;
